...
function Sidebar() {
  return (
    <div style={{width:"30vw",height:"100vh",backgroundColor:"black",display:"flex",flexDirection:"column",textAlign:"left",padding:"30px",position:"sticky",top:"0"}}>
        <img width="100%" src="https://storage.googleapis.com/pr-newsroom-wp/1/2018/11/Spotify_Logo_CMYK_Green.png" alt="logo"/>
        <div >
            <Link className='links' to="/home"><h3><MdOutlineHome/> Home</h3></Link>
